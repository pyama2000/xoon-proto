...
func (c *sampleServiceClient) Sample(ctx context.Context, in *SampleRequest, opts ...grpc.CallOption) (*SampleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/retty.sample.SampleService/Sample", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SampleService_Sample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/retty.sample.SampleService/Sample",
	}
...
var _SampleService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "retty.sample.SampleService",
	...
	Metadata: "retty/sample/sample.proto",
}
