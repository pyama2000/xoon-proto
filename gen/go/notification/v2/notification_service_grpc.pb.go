...
func (c *notificationServiceClient) PostSlackMessage(ctx context.Context, in *PostSlackMessageRequest, opts ...grpc.CallOption) (*PostSlackMessageResponse, error) {
	out := new(PostSlackMessageResponse)
	err := c.cc.Invoke(ctx, NotificationService_PostSlackMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotificationService_PostSlackMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostSlackMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationServiceServer).PostSlackMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_PostSlackMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).PostSlackMessage(ctx, req.(*PostSlackMessageRequest))
	}
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "notification/v2/notification_service.proto",
}
